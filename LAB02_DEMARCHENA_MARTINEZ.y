...
PROGRAM_START: 
	  TIPO_FUN NOMBRE_FUN PAR_IZQ OPT_PARAMS PAR_DER LLA_IZQ OPT_ARGS LLA_DER STOP
	;
...
DECLARACION_SI: 
	  SI PAR_IZQ DECLARACION_LOGICA OPT_DECLARACION_LOGICA PAR_DER LLA_IZQ OPT_ARGS LLA_DER DECLARACION_SINO 
	| SI error DECLARACION_LOGICA
	| SI PAR_IZQ DECLARACION_LOGICA OPT_DECLARACION_LOGICA error LLA_IZQ 
	;
...
DECLARACION_USAR_FUN: 
	  NOMBRE_FUN PAR_IZQ OPT_PARAMS_FUN PAR_DER
	;

OPT_PARAMS_FUN: 
	  PARAM_FUN OPT_PARAM_FUN
	;
...
OPT_DECLARACION_LOGICA: 
	  Y_O DECLARACION_LOGICA OPT_DECLARACION_LOGICA 
	| /* VACIO */
	;
...
DECLARACION_PARA: 
	  PARA PAR_IZQ ID_EL ASIGNAR_EL RoN PyC ID_EL OPERADOR_LOGICO PARAM_FUN PyC PASO PAR_DER LLA_IZQ OPT_ARGS LLA_DER
	;
...
PASO_2: 
	  ASIGNAR_EL ID_EL PASO_3
	;

PASO_3: 
	  PASO_1 
	| OPERADOR_ARITMETICO ID_EL
	;
...
DECLARACION_MIENTRAS_QUE: 
	  MIENTRAS_QUE PAR_IZQ DECLARACION_LOGICA OPT_DECLARACION_LOGICA PAR_DER LLA_IZQ OPT_ARGS LLA_DER
	;						

DECLARACION_HACER_HASTA: 
	  HACER LLA_IZQ OPT_ARGS LLA_DER MIENTRAS_QUE PAR_IZQ DECLARACION_LOGICA OPT_DECLARACION_LOGICA PAR_DER
	;

DECLARACION_DEPENDIENDO_DE: 
	  DEPENDIENDO_DE PAR_IZQ ID_EL PAR_DER LLA_IZQ OPT_CASOS LLA_DER
	;

OPT_CASOS: 
	  DECLARACION_CASO OPT_CASO
	;

DECLARACION_CASO: 
	  CASO CASO_P PP OPT_ARGS P_BREAK
	;
...
DECLARACION_LLAMAR_FUN: 
	  DECLARACION_USAR_FUN PyC
	;

DECLARACION_ASIGNAR_A_VAR: 
	  ID_EL ASIGNAR_EL VAR_1 PyC
	;
