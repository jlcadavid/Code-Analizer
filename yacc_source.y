...
PROGRAM_START: TIPO_FUN NOMBRE_FUN PAR_IZQ OPT_PARAMS PAR_DER LLA_IZQ OPT_ARGS LLA_DER E_O_F;
...
ID_EL: ID | L_ERROR { print("ERROR LEXICO EN LA LINEA: "); }; 	
...
OPT_PARS_L  : PAR_IZQ VALOR OPERADOR_LOGICO VALOR PAR_DER
			| VALOR OPERADOR_LOGICO VALOR
			;

VALOR	: DECLARACION_USAR_FUN 
...
DECLARACION_USAR_VAR: PARAM_FUN OP_L_O_A  PARAM_FUN;

OP_L_O_A: OPERADOR_LOGICO
		| Y_O
		| OPERADOR_ARITMETICO
		| NEGAR
		;
...
DECLARACION_PARA: PARA PAR_IZQ ID_EL ASIGNAR RoN PyC ID_EL OPERADOR_LOGICO PARAM_FUN PyC PASO PAR_DER LLA_IZQ OPT_ARGS LLA_DER;
...
DECLARACION_CASO: CASO V_ENTERO PP OPT_ARGS P_BREAK;

P_BREAK: INTERRUMPIR | /**/ ;

OPT_CASO: CASO OPT_CASO | /**/;

DECLARACION_LLAMAR_FUN: DECLARACION_USAR_FUN PyC;

DECLARACION_ASIGNAR_A_VAR: ID_EL ASIGNAR VAR_1 PyC;
